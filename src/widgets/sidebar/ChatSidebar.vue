...
const activeFilter = ref<"all" | "personal" | "groups">("all");
...
<template>
  ...
  >
    ...
    <div class="flex h-14 shrink-0 items-center gap-3 border-b border-neutral-grad-0 px-3">
      ...
      <span class="flex-1 text-base font-semibold text-text-color">
        Bastyon Chat
      </span>
      ...
      >
        <svg v-if="!searchOpen" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
    ...
    <div class="flex-1 overflow-y-auto">
      ...
      <ContactList v-else :filter="activeFilter" @select-room="handleSelectRoom" />
    </div>
  </div>
</template>
